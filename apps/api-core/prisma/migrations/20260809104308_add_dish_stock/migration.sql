...
INSERT INTO "new_Dish" ("categoryId", "createdAt", "desc", "id", "image", "merchantId", "name", "portionSize", "price", "sort", "specGroups", "specsPreset", "status", "tags", "updatedAt") SELECT "categoryId", "createdAt", "desc", "id", "image", "merchantId", "name", "portionSize", "price", "sort", "specGroups", "specsPreset", "status", "tags", "updatedAt" FROM "Dish";
DROP TABLE "Dish";
