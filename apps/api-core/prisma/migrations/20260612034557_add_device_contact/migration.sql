...
INSERT INTO "new_Device" ("branchId", "code", "createdAt", "id", "mode", "name", "sn", "status", "updatedAt") SELECT "branchId", "code", "createdAt", "id", "mode", "name", "sn", "status", "updatedAt" FROM "Device";
DROP TABLE "Device";
