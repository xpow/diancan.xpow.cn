...
.group-fr { display: inline-flex; align-items: center; font-size: 11px; line-height: 1; font-weight: 600; color: #ff6b00; background: rgba(255, 107, 0, 0.1); padding: 2px 8px; border-radius: 12px; white-space: nowrap; }
