...
.dish-stock-badge { position: absolute; top: 4px; right: 4px; padding: 4px 12px; border-radius: var(--radius-full); background: rgba(255, 61, 0, 0.85); color: #fff; font-family: var(--font-display); font-size: var(--text-label-lg); font-weight: 700; line-height: 1.5; pointer-events: none; box-shadow: 0 2px 8px rgba(255, 61, 0, 0.4); }
