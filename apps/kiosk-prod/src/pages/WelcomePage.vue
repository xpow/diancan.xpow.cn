...
.featured-thumb { position: relative; width: 112px; align-self: stretch; flex-shrink: 0; overflow: hidden; border-radius: var(--radius-lg) calc(var(--radius-xl) - 1px) calc(var(--radius-xl) - 1px) var(--radius-lg); }
